...
class KnowledgeItem(BaseModel):
    ...
    metadata: Dict[str, Any] = Field({}, description="Additional metadata for the knowledge item")
...
class GraphEntity(BaseModel):
    ...
    properties: Dict[str, Any] = Field({}, description="Key-value properties of the entity")
...
class GraphRelationship(BaseModel):
    ...
    properties: Dict[str, Any] = Field({}, description="Properties of the relationship")
...
class IndexingJob(BaseModel):
    ...
    indexed_documents: List[str] = Field([], description="List of document IDs that were indexed")
